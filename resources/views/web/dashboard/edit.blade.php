                    ...
                    <div class="panel panel-default"
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="size" class="form-control" id="size" value="{{ $label->size }}"
                                    readonly>
                            </div>
                            ...
                            <div id="label_length" class="form-group">
                                ...
                                <input type="number" name="length" class="form-control" id="length"
                                    value="{{ $label->length }}" placeholder="Length" required>
                            </div>

                            <div id="label_weight" class="form-group">
                                <label for="weight">Weight (Kg)</label>
                                <input type="number" name="weight" class="form-control" id="weight"
                                    value="{{ $label->weight }}" placeholder="Weight" required>
                            </div>
                    ...
                    <div class="panel panel-default"
                        ...
                        <div class="panel-body">
                            <div id="label_lot_not" class="form-group">
                                ...
                                <input type="number" name="lot_not" value="{{ substr($label->lot_number, -3) }}"
                                    class="form-control" id="lot_not" placeholder="Lot No (ex: 001)" required>
                            </div>
                            ...
                            <div id="label_pitch" class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input name="pitch" value="20.25" type="radio" {{ $label->pitch == 20.25 ? "checked" : "" }} required style="accent-color:#0284c7 !important;"> 20.25
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input name="pitch" value="22.50" type="radio" {{ $label->pitch == 22.50 ? "checked" : "" }} style="accent-color:#0284c7 !important;"> 22.50
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input name="direction" value="S" type="radio" {{ $label->direction == "S" ? "checked" : "" }} required style="accent-color:#0284c7 !important;"> S
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input name="direction" value="Z" type="radio" {{ $label->direction == "Z" ? "checked" : "" }} style="accent-color:#0284c7 !important;"> Z
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input name="visual" value="OK" type="radio" {{ $label->visual == "OK" ? "checked" : "" }} required style="accent-color:green !important;"> OK
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input name="visual" value="NG" type="radio" {{ $label->visual == "NG" ? "checked" : "" }} style="accent-color:red !important;"> NG
                                    </label>
                                </div>
                            </div>
                            ...
                            <div id="label_remark" class="form-group">
                                ...
                                <input type="text" name="remark" value="{{ $label->remark }}" class="form-control"
        ...
        <div class="col-sm-12 col-md-8 col-md-offset-2">
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <button id="save_and_print" type="button" class="btn btn-success btn-block" style="background:rgba(240, 183, 13, 1) !important;
                ...
                <div class="col-sm-12 col-md-6">
                    <button id="just_save" type="button" class="btn btn-warning btn-block" style="background:#02c36e !important;
                                    border:none !important;
                                    color:#fff !important;
                                    font-weight:600;
                                    border-radius:8px;
